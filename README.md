...
- [Exam Notes](#exam-notes)
  - [Number Systems and Bases](#number-systems-and-bases)
  ...
  - [Matricies and Graphs](#matricies-and-graphs)
    - [Matrix](#matrix)
      - [Matrix Operations](#matrix-operations)
        - [Addition and Subtraction.](#addition-and-subtraction)
        - [Scalar Multiplication](#scalar-multiplication)
        - [Dot product or matrix multiplication](#dot-product-or-matrix-multiplication)
    - [Graphs](#graphs)
      ...
      - [Representing graphs](#representing-graphs)
        ...
        - [Adjacency lists (weighted, undirected)](#adjacency-lists-weighted-undirected)
